...
function getEmptySet() {
    ...
    return new DiceSet(username, date, [], 0);
}
...
function addDiceToSet(firstDiceSet, secondDiceSet) {
    ...
    return new DiceSet(username, date, dice, firstDiceSet.modifier + secondDiceSet.modifier);
}
...
async function saveSetToServer() {
    ...
    if (currentDiceSet) {
        try {
            ...
            console.log('ERROR: Error saving dice set');
        }
    } else {
